...
void testApp::setup(){
	...
	urls.push_back("http://www.sohu.com");
	urls.push_back("https://github.com/liquidzym/ofxBerkelium");
	urls.push_back("http://www.openframeworks.cc");
	urls.push_back("http://vvvv.org");
	urls.push_back("http://www.baidu.com");
	urls.push_back("http://youku.com");
	urls.push_back("http://www.rexgo.net");
